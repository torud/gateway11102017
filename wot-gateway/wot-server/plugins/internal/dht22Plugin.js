...
Dht22Plugin.prototype.addValue = function(values) {
  ...
  // wenn Temperatur oder Luftfeuchtigkeit zu grosse Werte erreichen, Warnung über serielle Schnittstelle ausgeben
  if(values[1] > 75 || values[0] > 30) {
	  var message = 'Achtung! Temperatur: ' + values[0] + '°C, Luftfeuchtigkeit: ' + values[1] + '%\r\n';
