...
var CorePlugin = require('./../corePlugin').CorePlugin, util = require('util'), utils = require('./../../utils/utils.js');
            ...
            if (antwort.par) {
                ...
                switch (antwort.par.id) {
                    case 0:
                        ...
                        break;
                    case 1:
                        properties.targetHum = antwort.par.val;
                        break;
                    case 2:
                        properties.currTemp = antwort.par.val;
                        break;
                    case 3:
                        properties.currHum = antwort.par.val;
                        break;
                    case 4:
                        properties.duration = antwort.par.val;
                        break;
                    case 5:
                        properties.light = antwort.par.val;
                        break;
                    case 6:
                        properties.clock = antwort.par.val;
                        break;
                    case 7:
                        properties.relais = antwort.par.val;
                        break;
                    case 8:
                        properties.state = antwort.par.val;
                        break;
                    case 9:
                        properties.error = antwort.par.val;
                        break;
                    case 10:
                        properties.inUse = antwort.par.val;
                        break;
                    case 11:
                        properties.bathOn = antwort.par.val;
                        break;
                    case 12:
                        properties.libVersion = antwort.par.val;
                        break;
                    case 13:
                        properties.puVersion = antwort.par.val;
                        break;
                    case 14:
                        properties.bridgeVersion = antwort.par.val;
                        break;
                    default:
