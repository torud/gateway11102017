...
// JSON-String aus data erzeugen, um dem Property-Array data hinzuzufügen (bei addValue)
CorePlugin.prototype.createValue = function (data) {
  throw new Error('createValue(data) should be implemented by Plugin');
};

// Aktuelle Properties dem Property-Array data hinzufügen,
// wird vom Plugin selbst aufgerufen, wenn sich ein Property geändert hat (je nach Implementation)
CorePlugin.prototype.addValue = function (data) {
  //console.log('Model von Core-Plugin: ' + JSON.stringify(this.model));
